            ...
            <div className={`container-fluid px-5 py-3`}>
                <div className={`row`}>
                    <div className={`col-4 flex justify-start`}>
                        <img src="/images/epn_log_credits.png" alt="EPN LOGO" className={`${styles.logo_credits}`}/>
                    </div>
                    <div className={`col-4 flex justify-center`}>
                        <img src="/images/fis_logo_credits.png" alt="FIS LOGO" className={`${styles.logo_credits}`}/>
                    </div>
                    <div className={`col-4 flex justify-end`}>
                        <img src="/images/ludolab_logo_credits.png" alt="LUDOLAB LOGO" className={`${styles.logo_credits}`}/>
                    </div>
                </div>
                <div className={`row`}>
                ...
                <div className={`row py-3`}>
                    <div className={`col-12 flex justify-center`}>
                        <button>
                            <img src="/images/facebook.png" alt="Facebook LOGO" className={`h-10`}/>
                        </button>
                        <button>
                            <img src="/images/instagram.png" alt="Facebook LOGO" className={`h-10`}/>
                        </button>
                        <button>
                            <img src="/images/gorjeo.png" alt="Facebook LOGO" className={`h-10`}/>
                        </button>
                    </div>
                </div>
                <div className={`row`}>
                    <div className={`col-4 flex justify-center self-center`}>
                        <img src="/images/footer_logo_credits.png" alt="Creative_Commons_Logo"/>
                    </div>
                    <div className={`col-4 flex justify-center self-center`}>
